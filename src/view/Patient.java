...
public class Individual extends javax.swing.JFrame {
    ...
    public Individual() {
        ...
        try {
            ...
            System.out.println(generateIndividualId());
        ...
        private String generateIndividualId() throws SQLException, ClassNotFoundException {
...
GenderType genderType = getGenderTypeFromString(selectedGenderString);
        ...
        IndividualDto doctor = new IndividualDto( 
                txtFistname.getText(),
                txtLastname.getText(),
        ...
        try {
            ...
            pst.setString(1, generateIndividualId());
